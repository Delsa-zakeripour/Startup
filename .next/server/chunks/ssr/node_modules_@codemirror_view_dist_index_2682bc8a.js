...
class WidgetView extends ContentView {
    ...
    get overrideDOMText() {
        if (this.length == 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Text"].empty;
        let top = this;
        while(top.parent)top = top.parent;
        let { view } = top, text = view && view.state.doc, start = this.posAtStart;
        return text ? text.slice(start, start + this.length) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Text"].empty;
    }
    domAtPos(pos) {
...
class BlockWidgetView extends ContentView {
    ...
    get overrideDOMText() {
        return this.parent ? this.parent.view.state.doc.slice(this.posAtStart, this.posAtEnd) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Text"].empty;
    }
    domBoundsAround() {
        return null;
    }
...
class ContentBuilder {
    ...
    static build(text, from, to, decorations, dynamicDecorationMap) {
        ...
        builder.openEnd = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RangeSet"].spans(decorations, from, to, builder);
...
class DocView extends ContentView {
    ...
    coordsForChar(pos) {
        ...
        let end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"])(child.text, off);
...
function moveVertically(view, start, forward, distance) {
    ...
    for(let extra = 0;; extra += 10){
        ...
        if (curY < rect.top || curY > rect.bottom || (dir < 0 ? pos < startPos : pos > startPos)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos, assoc, undefined, goal);
        }
    }
}
...
class DOMReader {
    constructor(points, state){
        this.points = points;
        this.text = "";
        this.lineSeparator = state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorState"].lineSeparator);
    }
    append(text) {
        this.text += text;
    }
...
class DOMChange {
    constructor(view, start, end, typeOver){
        ...
        if (view.state.readOnly && start > -1) {
            ...
            this.newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].single(anchor, head);
        }
    }
}
    ...
    constructor(view){
        ...
        this.handlers.textupdate = (e)=>{
            ...
            let change = {
                from,
                to,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Text"].of(e.text.split("\n"))
            };
...
function runHandlers(map, event, view, scope) {
    ...
    if (scopeObj) {
        ...
        !(browser.windows && event.ctrlKey && event.altKey) && (baseName = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["base"][event.keyCode]) && baseName != name) {
...
//# sourceMappingURL=node_modules_%40codemirror_view_dist_index_2682bc8a.js.map